...
function publish(userToken, providers, parts, callback) {
    ...
    this.api.post('sharing/messages', undefined, {sharing_message: postParams}, function (error, result) {
...
function getAll (page, callback) {
    this.api.get('sharing/messages', undefined, {page: page}, function (error, result) {
