 ...
 * @param  {int}        pagination.page             the page number to fetch
 * @param  {int}        pagination.entries_per_page the number of items to fetch
 * @param  {string}     discussionReference         the discussion foreign id that identifies the discussion
 * @param  {Function}   callback                    the callback function
 */
function getComments(discussionToken, pagination, discussionReference, callback) {
